...
Tenha certeza que os graficos estejam funcionais e o app esteja de  acordo com o banco de dados
...
```sh
git clone https://github.com/GPT-Engineer-App/budget-tracking-app.git
